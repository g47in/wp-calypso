...
class PaymentMethodStripe extends Component {
	...
	// TODO - onCancel, clear the userRequestedKeyFlow and userRequestedConnectFlow flags
	...
	getButtons = () => {
		...
		buttons.push( { action: 'save', label: translate( 'Done' ), onClick: onDone, isPrimary: true } );
